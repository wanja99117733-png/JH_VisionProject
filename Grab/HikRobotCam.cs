...
namespace JH_VisionProject.Grab
{
    ...
    internal class HikRobotCam : IDisposable
    {
        ...
        void FrameGrabedEventHandler(object sender, FrameGrabbedEventArgs e)
        {
            ...
            if (_userImageBuffer[BufferIndex].ImageBufferPtr != null)
            {
        ...
        internal bool Open()
        {
            try
            {
                ...
                if (!_device.IsConnected)
                {
                    ...
                    {
                        _device.Dispose();
                        Console.WriteLine("Device open failed", ret);
                        return false;
                    }
                    if (_device is IGigEDevice)
                    {
                        ...
                        {
                            Console.WriteLine("Warning: Get Optimal Packet Size failed {0:x8}", ret);
                        }
                    }
        ...
        internal bool GetPixelBpp(out int pixelBpp)
        {
            ...
            if (result != MvError.MV_OK)
            {
                Console.WriteLine("Get Pixel Format failed:{0:x8}", result);
                return false;
            }
        ...
        internal bool SetExposureTime(long exposure)
        {
            ...
            _device.Parameters.SetFloatValue("ExposureAuto", 0);
        ...
        internal bool SetGain(long gain)
        {
            ...
            _device.Parameters.SetFloatValue("GainAuto", 0);
        ...
        internal bool GetResolution(out int width, out int height, out int stride)
        {
            ...
            if (result != MvError.MV_OK)
            {
                Console.WriteLine("Get Pixel Format failed: nRet {0:x8}", result);
                return false;
            }
