...
namespace JH_VisionProject.Sequence
{
    ...
    public class Communicator
    {
        ...
        private IMessageDuplexClient _clinet;   // 클라이언트
        ...
        public void Create(CommunicatorType type, params object[] parameters)   //접속용
        {
            switch (type)
            {
                ...
                case CommunicatorType.WCF:
                    ...
                    _clinet = new MessageDuplexClient(BindingType.Tcp, ip); //연결하기 위한 코드 
            ...
            _clinet.Connect();
            //위에 코드들을 통해 생길 사건에 대해 이벤트 핸들러를 등록
        }
